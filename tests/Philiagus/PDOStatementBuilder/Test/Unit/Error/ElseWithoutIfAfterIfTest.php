...
class ElseWithoutIfAfterIfTest extends ErrorUnit
{

    protected function getExceptionMessage(): string
    {
        return 'Trying to create else outside if structure';
    }

    protected function buildStatement(Builder $builder, array $further): void
    {
        $builder->build("{$builder->if(0)}{$builder->else()}{$builder->endif()}{$builder->else()}");
    }
}